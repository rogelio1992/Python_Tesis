...
urlpatterns = [
  ...
  path('synop/utiles/reporte_diario/', ReporteDiario.as_view(), name= 'reporte_diario'),
  ...
  path('synop/<int:id>/datos_adinociales/', DatosAdinocialesListView.as_view(), name='datos_adinociales_list'),
  path('synop/<int:id>/datos_adinociales/<int:pk>/update/', DatosAdinocialesUpdateView.as_view(), name='datos_adinociales_update'),
  path('synop/<int:id>/datos_adinociales/<int:pk>/delete/', SynopDeleteView.as_view(), name='datos_adinociales_delete'),
  path('synop/<int:pk>/details/', SynopDetailView.as_view(), name='datos_adinociales_detail'),
  path('pronostico/list/', PronosticoListView.as_view(), name='pronostico_list'),
  path('pronostico/create/', PronosticoCreateView.as_view(), name='pronostico_create'),
  path('pronostico/<int:pk>/update/', PronosticoUpdateView.as_view(), name='pronostico_update'),
  path('pronostico/<int:pk>/delete/', PronosticoDeleteView.as_view(), name='pronostico_delete'),
  path('pronostico/<int:pk>/details/', PronosticoDetailView.as_view(), name='pronostico_detail'),
  ...
  path('provincia/<int:pk>/update/', ProvinciaUpdateView.as_view(), name='provincia_update'),
  path('provincia/<int:pk>/delete/', ProvinciaDeleteView.as_view(), name='provincia_delete'),
  ...
  path('estacion/<int:pk>/update/', EstacionUpdateView.as_view(), name='estacion_update'),
  path('estacion/<int:pk>/delete/', EstacionDeleteView.as_view(), name='estacion_delete'),
